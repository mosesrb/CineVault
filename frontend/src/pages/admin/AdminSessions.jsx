...
export default function AdminSessions() {
  ...
  return (
    <div className="animate-fadeUp">
      <div style={{ marginBottom: 'var(--sp-6)', display:'flex', alignItems:'center', gap:'var(--sp-2)' }}>
        <Link to="/admin" className="btn btn-ghost btn-sm" style={{padding:8, borderRadius:'50%', width:36, height:36, justifyContent:'center'}}>
          <ChevronLeft size={20} />
        </Link>
        <div>
          <h1 className="section-heading" style={{margin:0}}>Active Sessions</h1>
          <p className="text-muted text-sm">Manage all devices connected to your CineVault instance.</p>
        </div>
      </div>
